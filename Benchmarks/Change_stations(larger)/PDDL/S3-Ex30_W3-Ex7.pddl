(define (problem S3-Ex30_W3-Ex7)
    ...
    (:goal
        ...
        (product-at-buffer product6 buffer3)
        (product-at-buffer product7 buffer3)
        (product-at-buffer product8 buffer3)
        (product-at-buffer product9 buffer3)
        (product-at-buffer product10 buffer3)
        )
    )
