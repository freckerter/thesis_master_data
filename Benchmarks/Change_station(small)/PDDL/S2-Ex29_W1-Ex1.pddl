(define (problem S2-Ex29_W1-Ex1)
    (:domain flow-shop)
    (:objects
        worker1 - worker
        station1 station2 - station
        buffer0 buffer1 buffer2 - buffer
    ...
    (:goal
        (and
        (product-at-buffer product1 buffer2)
        (product-at-buffer product2 buffer2)
        (product-at-buffer product3 buffer2)
        (product-at-buffer product4 buffer2)
        (product-at-buffer product5 buffer2)
        )
    )
