(define (problem S7-Ex18_W1-Ex1)
    (:domain flow-shop)
    (:objects
        worker1 - worker
        station1 station2 station3 station4 station5 station6 station7 - station
        buffer0 buffer1 buffer2 buffer3 buffer4 buffer5 buffer6 buffer7 - buffer
    ...
    (:goal
        (and
        (product-at-buffer product1 buffer7)
        (product-at-buffer product2 buffer7)
        (product-at-buffer product3 buffer7)
        (product-at-buffer product4 buffer7)
        (product-at-buffer product5 buffer7)
        )
    )
