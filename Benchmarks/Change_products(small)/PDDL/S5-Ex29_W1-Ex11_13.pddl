(define (problem S5-Ex29_W1-Ex11_13)
    (:domain flow-shop)
    (:objects
        worker1 - worker
        station1 station2 station3 station4 station5 - station
        buffer0 buffer1 buffer2 buffer3 buffer4 buffer5 - buffer
        helpproduct product1 product2 product3 product4 product5 product6 product7 product8 product9 product10 product11 product12 product13 - product
        variant1 - variant
    )
